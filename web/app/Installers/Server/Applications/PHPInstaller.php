...
class PHPInstaller
{
    ...
    public $logFilePath = '/var/log/TM/php-installer.log';
    ...
    public function install()
    {
        ...
        $commands[] = 'apt install -y ' . $dependencies;

        $commands[] = 'sudo a2enmod php' . $this->phpVersions[0];
        ...
        $commands[] = 'sudo a2enconf ssl-params';
