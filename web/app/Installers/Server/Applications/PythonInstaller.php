...
class PythonInstaller
{
    ...
    public $logFilePath = '/var/log/TM/python-installer.log';
    ...
    public function install()
    {
        ...
        foreach ($this->pythonVersions as $pythonVersion) {
            $commands[] = 'apt install -y python' . $pythonVersion;
            $commands[] = 'apt install -y python' . $pythonVersion . '-dev';
            $commands[] = 'apt install -y python' . $pythonVersion . '-venv';
            $commands[] = 'apt install -y python' . $pythonVersion . '-setuptools';
            $commands[] = 'apt install -y python' . $pythonVersion . '-wheel';
        }
