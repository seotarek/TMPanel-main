...
cp -f /usr/local/TM/samples/ubuntu/nginx.conf.sample $SITES_AVAILABLE_DIR/$DOMAIN.conf
...
cp -f /usr/local/TM/samples/sample-website-index.html $SERVER_ROOT/index.html
